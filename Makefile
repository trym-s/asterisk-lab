...
RSYNC_EXCLUDES := --exclude='.git/' --exclude='.github/' --exclude='.env' --exclude='.agents/' --exclude='.claude/' --exclude='.codex/' --exclude='.mcp.json' --exclude='AGENTS.md' --exclude='README.md' --exclude='PROCESS.md' --exclude='NOTES.md' --exclude='docs/' --exclude='__pycache__/' --exclude='.rendered/'
